...
export default function VendorSignUp() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await signUp.create({
        ...
        unsafeMetadata: { role: 'vendor', company: form.company, phone: form.phone },
      });
  ...
  return (
    <div className="max-w-md mx-auto mt-16 p-8 bg-white border border-[#89B3E5] rounded shadow-sm">
      <h1 className="text-2xl font-bold text-[#154278] mb-2">Vendor - Create your account</h1>
      <p className="text-[#6B8CAE] mb-6">For pre-audited transportation technology providers.</p>
